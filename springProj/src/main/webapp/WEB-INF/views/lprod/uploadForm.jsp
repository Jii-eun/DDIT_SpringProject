...
<!-- 파일 업로드
 ...
 //------------------이미지 미리보기 시작------------------
 		...
 		// ↓해당 함수가 쓰이는 곳..?의 객체가 e로 들어옴..으로 이해
 		function handleImgFileSelect(e){
 			//e.target = 이벤트가 발생된 target = <input type="file"... 13번째 줄
 			...
 			fileArr.forEach(function(f){
 				...
 				//reader가 생성될때 자동으로 실행됨↓
 				reader.onload = function(e){
 					//e.target : 이미지 객체
 					//e.target.result : reader가 이미지를 다 읽은 결과
 										//여기에 p태그를 넣으면 이미지가 한줄씩 출력된다.
 ...
 <!-- 
 	...
 	요청방식 : post
  -->
<div class="imgs_wrap" style="width:200px;"></div>
